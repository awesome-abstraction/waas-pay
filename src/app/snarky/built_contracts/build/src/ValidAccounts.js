...
export class ValidAccounts extends SmartContract {
    ...
    updateEmployerHash(inputEmployerHash) {
        const newItem = new Field(2);
        this.employerHash.set(newItem);
        Provable.log(this.employerHash.getAndAssertEquals());
        // // precondition
        // // const employerHash = this.employerHash.get();
        // // this.employerHash.assertEquals(employerHash);
        // // hasn't been used yet, set it
        // // this.employerHash.assertEquals(Field(0));
        // Field(10).assertEquals(Field(10))
        // this.employerHash.set(inputEmployerHash);
        // Provable.log("set value", inputEmployerHash)
        // Provable.log("set successful", this.employerHash.getAndAssertEquals())
        // // const tryNew = this.employerHash.getAndAssertEquals()
        // // Provable.log("try new", tryNew)
        // setTimeout(() => {
        //   Provable.log(this.employerHash.getAndAssertEquals())
        // }, 2000)
        // this.employerHash.set(Field(2));
        // Provable.log(this.employerHash.getAndAssertEquals())
    }
...
__decorate([
    state(Field),
    __metadata("design:type", Object)
], ValidAccounts.prototype, "x", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
    __metadata("design:returntype", void 0)
], ValidAccounts.prototype, "setX", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field]),
